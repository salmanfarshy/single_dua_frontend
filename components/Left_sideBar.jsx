  ...
  return (
    <div className=" flex items-center justify-center lg:my-auto sm:mx-auto">
      <div className=" lg:ms-6 sm:ms-0 bg-customWhite lg:h-[39rem] lg:w-20 sm:w-[55rem] sm:h-20 rounded-3xl flex shrink items-center justify-between lg:gap-4 sm:px-12 lg:px-0 lg:py-6 sm:py-0 lg:flex-col sm:flex-row lg:mt-0 sm:mt-4">
        ...
        <Mini_icon url="/images/memorize.svg" />
        <Mini_icon url="/images/bookmark.svg" />
        <Mini_icon url="/images/ruqyah.svg" />
        <Mini_icon url="/images/dua-info.svg" />
        <Mini_icon url="/images/books.svg" />

        <div className="h-14 w-14 flex justify-center items-center lg:mx-auto sm:my-auto bg-customGreen rounded-xl cursor-pointer select-none">
          <svg
            width="28"
            height="28"
            viewBox="0 0 24 24"
